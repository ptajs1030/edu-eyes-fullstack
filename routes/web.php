...
Route::middleware(['auth', 'verified', 'role:admin'])->group(function () {
    ...
    Route::post('/payments/{payment}/async-resend-notification', [PaymentController::class, 'resendNotification'])->name('payments.async-resend-notification');
    Route::post('/payments/{payment}/sync-resend-notification', [PaymentController::class, 'manualResendNotification'])->name('payments.sync-resend-notification');
    ...
    Route::post('/tasks/{task}/async-resend-notification', [TaskController::class, 'resendNotification'])->name('tasks.async-resend-notification');
    Route::post('/tasks/{task}/sync-resend-notification', [TaskController::class, 'manualResendNotification'])->name('tasks.sync-resend-notification');
