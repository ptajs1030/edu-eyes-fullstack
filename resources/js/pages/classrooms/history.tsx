...
export default function ClassroomHistory({ classroom, academicYears, selectedAcademicYear, students, filters }: Props) {
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">
                            Classroom History: {classroom.name} (Level {classroom.level})
                        </h1>
                        <p className="mt-1 text-gray-600">View student history for this classroom</p>
                    </div>
